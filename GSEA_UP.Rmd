...
entrez_to_symbols <- function(entrez_list, gene_annotations, ntop = 24) {
  ...
  # Filter out NA entrezids, keep only first symbol per entrezid, and create hash-like lookup for O(1) access
  ...
  convert_single <- function(entrez_string) {
    ...
    # Use match() for safe vectorized lookup with proper NA handling
