...
```{r}
data_dir       <- "/Users/mdozmorov/Documents/Data/VCU_work/Sarkar/2021-04.RNA-seq/" # Working directory
...
sample_annotation$Sample <- sub(".ReadsPerGene.out.tab.gz", "", sample_annotation$Sample) # For STAR files
...
"AlbMda9" vs. "WT" comparison, so positive logFC correspond to genes UP in "AlbMda9"
...
res.full <- p.vals(object = lrt, p_adj_cutoff = p_adj_cutoff, comparison = analysis_ID, print_to_file = FALSE)
