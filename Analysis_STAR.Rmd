...
counts_average <- inner_join(counts_average, grcm38[, c("ensgene", "symbol", "description")], by = c("Geneid" = "ensgene"))
```
...
if( run_gsea == FALSE) {
  ...
  if(websiteLive) {
    ...
    if (class(res.kegg) == "data.frame") {
      ...
      save_res(res.kegg[res.kegg$Adjusted.P.value < p_adj_cutoff, , drop = FALSE], fileName = fileName_rna, wb = wb, sheetName = "KEGG_1")
