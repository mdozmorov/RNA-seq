...
kegg_ids <- c(xx$path_id[xx$path_name %in% kegg_names]) # All KEGG IDs
kegg_ids <- kegg_ids[match(kegg_names, xx$path_name[xx$path_name %in% kegg_names])] # Match name order
